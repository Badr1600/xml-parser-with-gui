...
public class ReadXmlFiles
{
    ...
    public static void readData(Attribute id)
    {
        ...
        File xmlFile = new File("/Users/ahmed/XML-Editor/sample.xml");
    ...
    {
        SAXBuilder builder = new SAXBuilder();
        File xmlFile = new File("/home/maria/Downloads/sample2.xml");
        ...
        try
        {
            ...
            xmlOutput.output(document,
                    new FileWriter("/home/maria/Downloads/sample2.xml"));
    ...
    // public static void writeAndModifyTitle(Attribute id, String newTitle) {
    // SAXBuilder builder = new SAXBuilder();
    // File xmlFile = new File("/home/maria/Downloads/sample2.xml");
    //
    // try {
